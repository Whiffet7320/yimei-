	...
	<view class="index">
		<view class="nav1">
			<view class="nav1-flex">
				<image class="pic" :src="userInfo.avatar" mode="aspectFill" v-if="userInfo.avatar" @click="onSet">
				</image>
			...
			<view class="uc-item">
				...
				<view class="uc-item-body">
					<view class="uc-item-body-item" @click='gotoOrder(1)'>
						<view class="pic">
							<image src="../../static/image/user/daifukuan.png" mode="aspectFit"
								style="width: 46rpx;height: 45rpx;"></image>
							<u-badge bgColor="#BD9E81" :count="userInfo.orderStatusNum.unpaid_count" :offset="[-12,-16]"
								v-if="userInfo.orderStatusNum"></u-badge>
						</view>
						<view class="uc-item-body-item-text">待付款</view>
					</view>
					<view class="uc-item-body-item" @click='gotoOrder(2)'>
						<view class="pic">
							<image src="../../static/image/user/daifuweikuan.png" mode="aspectFit"
								style="width: 46rpx;height: 45rpx;"></image>
							<u-badge bgColor="#BD9E81" :count="userInfo.weikuan_num" :offset="[-12,-16]"
								v-if="userInfo.weikuan_num"></u-badge>
						</view>
						<view class="uc-item-body-item-text">待付尾款</view>
					</view>
					<view class="uc-item-body-item" @click='gotoOrder(6)'>
						<view class="pic">
							<image src="../../static/image/user/yiwancheng.png" mode="aspectFit"
								style="width: 46rpx;height: 45rpx;"></image>
						</view>
					...
					<view class="uc-item-body-item" @click='gotoOrder(7)'>
						<view class="pic">
							<image src="../../static/image/user/yiguanbi.png" mode="aspectFit"
			...
			<view class="uc-item">
				...
				<view class="uc-item-body">
					<view class="uc-item-body-item" @click="goAddress">
						<view class="pics">
							<image src="../../static/image/user/dizhiguanli.png" mode="aspectFit"
					...
					<view class="uc-item-body-item" @click="onShare">
						<view class="pics">
							<image src="../../static/image/user/fenxiangma.png" mode="aspectFit"
								style="width:37rpx;height:37rpx;"></image>
						</view>
					...
					<view class="uc-item-body-item" @click="onMeet">
						<view class="pics">
							<image src="../../static/image/user/wodeyuyue.png" mode="aspectFit"
								style="width:34rpx;height:37rpx;"></image>
						</view>
					...
					<view class="uc-item-body-item" @click="onPoint">
						<view class="pics">
							<image src="../../static/image/user/wodejifen.png" mode="aspectFit"
								style="width:42rpx;height:37rpx;"></image>
						</view>
					...
					<view class="uc-item-body-item" @click="onPointOrder">
						<view class="pics">
							<image src="../../static/image/user/jifendingdan.png" mode="aspectFit"
								style="width:32rpx;height:37rpx;"></image>
						</view>
					...
					<view class="uc-item-body-item" @click="onTeam">
						<view class="pics">
							<image src="../../static/image/user/wodetuandui.png" mode="aspectFit"
								style="width:44rpx;height:37rpx;"></image>
						</view>
			...
			<view class="uc-item">
				<view class="uc-item-last">
					<view class="uc-item-last-item" @click="onCall">
						<image src="../../static/image/user/dianhua.png" mode="aspectFit"
							style="width: 26rpx;height:34rpx;"></image>
					...
					<view class="uc-item-last-item">
						<button class="u-reset-button contactbtn" open-type="contact">
							<image src="../../static/image/user/kefu.png" mode="aspectFit"
					...
					<!-- #endif -->
					<!-- #ifdef APP-PLUS -->
					<view class="uc-item-last-item" @click="CallPhone(tel);">
						<view class="u-reset-button contactbtn">
							<image src="../../static/image/user/kefu.png" mode="aspectFit"
								style="width: 30rpx;height:30rpx;"></image>
							<view class="uc-item-last-item-text">专属客服</view>
							<image class="icon" src="../../static/image/user/icon_right.png"></image>
